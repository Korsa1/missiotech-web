...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-r from-[#003B4F] to-[#0A6E8A] text-white py-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="page-transition">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Technology with a Mission</h1>
            <p className="text-xl mb-8 opacity-90">
              MissioTech empowers organizations through innovative AI integration, 
              immersive VR/XR training, and strategic consulting services.
            </p>
          ...
          <div className="flex justify-center md:justify-end page-transition">
            <div className="relative w-64 h-64 md:w-80 md:h-80 bg-white p-6 rounded-lg shadow-lg">
              <Image 
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-16 md:h-24">
          <path fill="#ffffff" d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" opacity=".25"></path>
